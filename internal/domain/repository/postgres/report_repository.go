...
type ReportRepository interface {
	...
	FindReportsByQuery(db database.Database, query string, objectType string, statuses []enum.ReportStatus, options *QueryOptions) ([]*entity.Report, error)
	CountReportsByQuery(db database.Database, query string, objectType string, statuses []enum.ReportStatus) (int64, error)
}
