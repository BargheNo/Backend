...
type MaintenanceRepository interface {
	...
	FindCorporationRequestsByStatusAndQuery(db database.Database, corporationID uint, allowedStatuses []enum.MaintenanceRequestStatus, query string, options *QueryOptions) ([]*entity.MaintenanceRequest, error)
	CountCorporationRequestsByStatusAndQuery(db database.Database, corporationID uint, allowedStatuses []enum.MaintenanceRequestStatus, query string) (int64, error)
