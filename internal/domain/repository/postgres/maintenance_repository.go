...
type MaintenanceRepository interface {
	...
	FindCorporationRequestsByStatusAdnQuery(db database.Database, corporationID uint, allowedStatuses []enum.MaintenanceRequestStatus, query string, options *QueryOptions) ([]*entity.MaintenanceRequest, error)
	CountCorporationRequestsByStatusAdnQuery(db database.Database, corporationID uint, allowedStatuses []enum.MaintenanceRequestStatus, query string) (int64, error)
