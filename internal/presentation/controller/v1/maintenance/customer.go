...
func (maintenanceController *CustomerMaintenanceController) UpdateMaintenanceRequest(ctx *gin.Context) {
	...
	err := maintenanceController.maintenanceService.UpdateMaintenanceRequest(requestInfo)
	if err != nil {
		panic(err)
	}
...
func (maintenanceController *CustomerMaintenanceController) CancelMaintenanceRequest(ctx *gin.Context) {
	...
	err := maintenanceController.maintenanceService.CancelMaintenanceRequest(maintenanceInfo)
	if err != nil {
		panic(err)
	}
...
func (maintenanceController *CustomerMaintenanceController) ApproveMaintenanceRecord(ctx *gin.Context) {
	...
	err := maintenanceController.maintenanceService.ApproveMaintenanceRecord(maintenanceInfo)
	if err != nil {
		panic(err)
	}
